...
mv ..\target\x86_64-unknown-uefi\debug\uefi-async.efi .\qemu\EFI\BOOT\BOOTX64.EFI
...
mv ..\target\x86_64-unknown-uefi\release\uefi-async.efi .\qemu\EFI\BOOT\BOOTX64.EFI
rm .\qemu\EFI\BOOT\BOOTX64.EFI
cargo build --release
```